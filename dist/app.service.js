...
let AppService = class AppService {
    ...
    async startSpider() {
        ...
        await page.goto('https://www.zhipin.com/web/geek/job?query=java&city=101210100');
        ...
        for (let i = 1; i <= totalPage; i++) {
            await page.goto('https://www.zhipin.com/web/geek/job?query=java&city=101210100&page=' + i);
            await page.waitForSelector('.job-list-box');
